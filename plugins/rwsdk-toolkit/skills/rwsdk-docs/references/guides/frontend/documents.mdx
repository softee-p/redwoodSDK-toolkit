...
2. Use the Document component in your routes:
    ...
    import { Document } from '@/app/Document.tsx' // [!code highlight]
    import { HomePage } from '@/app/pages/HomePage.tsx'

    export default defineApp([
      render(Document, [ // [!code highlight]
        route('/', HomePage),
      ])
    ])
    ```
...
```tsx title="src/worker.tsx" collapse={8-11}
// [!code word:StaticDocument]
// [!code word:ApplicationDocument]
// [!code word:RealtimeDocument]
import { defineApp } from 'rwsdk/worker'
