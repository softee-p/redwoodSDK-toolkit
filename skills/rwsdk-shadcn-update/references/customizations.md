...
**Update Strategy:**
1. Backup before updating: `bash .claude/skills/rwsdk-shadcn-update/scripts/backup-components.sh`
2. Update via CLI: `pnpx shadcn@latest add component-name --overwrite`
3. Restore from backup: `bash .claude/skills/rwsdk-shadcn-update/scripts/restore-components.sh`
