...
description: Manage shadcn/ui components in RedwoodSDK projects with safe updates and RSC compliance. Use when: (1) Updating existing shadcn/ui components, (2) Adding new shadcn/ui components, (3) Troubleshooting shadcn component issues, (4) Ensuring proper RSC (React Server Components) usage, (5) Preserving custom component modifications, (6) Questions about shadcn setup or configuration in RedwoodSDK projects.
---
...
```bash
bash .claude/skills/rwsdk-shadcn-update/scripts/backup-components.sh
```
...
```bash
bash .claude/skills/rwsdk-shadcn-update/scripts/restore-components.sh
```
...
```bash
bash .claude/skills/rwsdk-shadcn-update/scripts/safe-update.sh
```
...
All scripts located in `.claude/skills/rwsdk-shadcn-update/scripts/`:
...
1. Copy `.claude/skills/rwsdk-shadcn-update/` directory
